...
For Distance Metrics, three functions are needed:
 ...
 - `def metric_pdf(data, pdf_params)`: Calculates the probability density function for the given data (a numpy array), with the optional given params (a dictionary).
